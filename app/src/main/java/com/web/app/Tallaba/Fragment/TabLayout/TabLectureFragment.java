...
import com.web.app.Tallaba.ViewModel.LecturesVM;
...
public class TabLectureFragment extends Fragment {
    RecyclerView recyclerView;
    SharedPreferences sharedPreferences;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View root= inflater.inflate(R.layout.fragment_tab_lecture, container, false);
        recyclerView = root.findViewById(R.id.rec_lecture);
    ...
    void getLectureList() {
        LecturesVM vm = new ViewModelProvider(this).get(LecturesVM.class);
        vm.getLecture(    sharedPreferences.getString(getString(R.string.userID),"0"));
